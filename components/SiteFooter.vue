  ...
  <footer class="footer">
    <nav>
      <ul>
        ...
        <li>
          <h3>Credits</h3>
          <p>Inspired by <a href="http://tiagoluis.eu/portfolio/imdb-redesign/">IMDb | Redesign by #TiagoLuís</a></p>
        </li>
